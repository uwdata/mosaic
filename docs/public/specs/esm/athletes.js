...
export default vg.hconcat(
  vg.vconcat(
    vg.hconcat(
      ...
      vg.search({ label: "Name", as: $query, from: "athletes", column: "name", type: "contains" })
    ),
    vg.vspace(10),
    vg.plot(
      vg.dot(
    ...
    vg.vspace(5),
    vg.table({ from: "athletes", maxWidth: 570, height: 250, filterBy: $query, columns: ["name","nationality","sex","height","weight","sport"], width: {"name":180,"nationality":100,"sex":50,"height":50,"weight":50,"sport":100} })
  )
);