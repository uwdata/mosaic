...
view = vg.vconcat(
    vg.hconcat(
        vg.plot(vg.bar_y(data="md", x="u", y="v", fill="steelblue")),
        vg.plot(
            vg.line_y(
                data="md",
                x="u",
        ...
        vg.plot(vg.text(data="md", x="u", y="v", text="u", fill="steelblue")),
        vg.plot(vg.tick_y(data="md", x="u", y="v", stroke="steelblue")),
        vg.plot(vg.area_y(data="md", x="u", y="v", fill="steelblue")),
    ),
    vg.hconcat(
        vg.plot(
        ...
        vg.plot(
            vg.dense_line(
                data="md", x="i", y="v", fill="density", bandwidth=2, pixel_size=1
            ),
            vg.color_scheme("blues"),
            vg.x_domain([-1, 8]),
        ),
