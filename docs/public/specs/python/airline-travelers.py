...
view = vg.plot(
    vg.rule_y(data=[0]),
    vg.line_y(data="travelers", x="date", y="previous", stroke_opacity=0.35),
    vg.line_y(data="travelers", x="date", y="current"),
    vg.text(
        data="endpoint",
        x="date",
        y="previous",
    ...
    vg.text(
        data="endpoint", x="date", y="current", text=["2020"], line_anchor="top", dy=6
    ),
    vg.y_grid(True),
