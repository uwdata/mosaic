...
The code below shows an example specification in both YAML and JSON formats, as well as corresponding JavaScript code produced by [`astToESM`](parser-generators#asttoesm) and Python code produced by [`astToPython`](parser-generators#asttopython).
