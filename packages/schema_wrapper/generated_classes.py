...
class AggregateTransform(SchemaBase):
    def __init__(self, value: Union["Quantile", "StddevPop", "Variance", "Min", "Max", "Count", "Avg", "Product", "Mode", "First", "Last", "VarPop", "Argmax", "Argmin", "Median", "Stddev", "Sum"]):
        self.value = value


class ChannelValue(SchemaBase):
    def __init__(self, value: Union[float, bool, "Transform", "SQLExpression", "AggregateExpression", str, List[Any], Any]):
        self.value = value
...
class Argmax(SchemaBase):
    def __init__(self, argmax: List[Union[float, str, bool]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.argmax = argmax
...
class Argmin(SchemaBase):
    def __init__(self, argmin: List[Union[float, str, bool]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.argmin = argmin
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
...
class Avg(SchemaBase):
    def __init__(self, avg: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.avg = avg
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
...
class Centroid(SchemaBase):
    def __init__(self, centroid: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
        self.centroid = centroid


class CentroidX(SchemaBase):
    def __init__(self, centroidX: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
        self.centroidX = centroidX


class CentroidY(SchemaBase):
    def __init__(self, centroidY: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
...
class ColumnTransform(SchemaBase):
    def __init__(self, value: Union["GeoJSON", "CentroidX", "Bin", "DateDay", "CentroidY", "DateMonth", "DateMonthDay", "Centroid"]):
        self.value = value


class Component(SchemaBase):
    def __init__(self, value: Union["VSpace", "HSpace", "Search", "HConcat", "Slider", "VConcat", "PlotMark", "Table", "Plot", "Legend", "Menu"]):
        self.value = value
...
class DataDefinition(SchemaBase):
    def __init__(self, value: Union["DataCSV", "DataTable", "DataQuery", "DataFile", "DataJSONObjects", "DataSpatial", "DataArray", "DataJSON", "DataParquet"]):
        self.value = value
...
class DateDay(SchemaBase):
    def __init__(self, dateDay: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
        self.dateDay = dateDay


class DateMonth(SchemaBase):
    def __init__(self, dateMonth: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
        self.dateMonth = dateMonth


class DateMonthDay(SchemaBase):
    def __init__(self, dateMonthDay: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
...
class First(SchemaBase):
    def __init__(self, first: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.first = first
        self.orderby = orderby
        self.partitionby = partitionby
...
class FirstValue(SchemaBase):
    def __init__(self, first_value: Union[Union[float, str, bool], List[Union[float, str, bool]]], orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
...
class GeoJSON(SchemaBase):
    def __init__(self, geojson: Union[Union[float, str, bool], List[Union[float, str, bool]]]):
...
class Lag(SchemaBase):
    def __init__(self, lag: Union[Union[float, str, bool], List[Union[float, str, bool]]], orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.lag = lag
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class Last(SchemaBase):
    def __init__(self, last: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.last = last
        self.orderby = orderby
        self.partitionby = partitionby
...
class LastValue(SchemaBase):
    def __init__(self, last_value: Union[Union[float, str, bool], List[Union[float, str, bool]]], orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
...
class Max(SchemaBase):
    def __init__(self, max: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.max = max
        self.orderby = orderby
        self.partitionby = partitionby
...
class Median(SchemaBase):
    def __init__(self, median: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.median = median
        self.orderby = orderby
        self.partitionby = partitionby
...
class Min(SchemaBase):
    def __init__(self, min: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.min = min
        self.orderby = orderby
        self.partitionby = partitionby
...
class Mode(SchemaBase):
    def __init__(self, mode: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.mode = mode
        self.orderby = orderby
        self.partitionby = partitionby
...
class NTile(SchemaBase):
    def __init__(self, ntile: Union[Union[float, str, bool], List[Union[float, str, bool]]], orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.ntile = ntile
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class NthValue(SchemaBase):
    def __init__(self, nth_value: Union[Union[float, str, bool], List[Union[float, str, bool]]], orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
...
class ParamDefinition(SchemaBase):
    def __init__(self, value: Union["Selection", "ParamValue", "ParamDate", "Param"]):
        self.value = value
...
class PlotInteractor(SchemaBase):
    def __init__(self, value: Union["ToggleColor", "IntervalX", "PanZoomX", "ToggleY", "IntervalY", "PanX", "PanY", "PanZoom", "Highlight", "PanZoomY", "IntervalXY", "NearestY", "NearestX", "Pan", "Toggle", "ToggleX"]):
        self.value = value


class PlotMark(SchemaBase):
    def __init__(self, value: Union["GridFx", "ErrorBarY", "LineY", "TextY", "DotY", "RasterTile", "CellX", "Density", "Voronoi", "DenseLine", "VectorY", "GridX", "Raster", "VectorX", "Frame", "AreaX", "TickX", "ErrorBarX", "RuleY", "Rect", "DensityY", "RuleX", "Image", "AxisFy", "RegressionY", "DelaunayLink", "Hexbin", "DotX", "Graticule", "Circle", "Geo", "Hexgrid", "Line", "DensityX", "Text", "RectY", "Spike", "AxisX", "Cell", "GridFy", "RectX", "LineX", "BarX", "Hexagon", "Arrow", "Heatmap", "Link", "Vector", "Dot", "VoronoiMesh", "Hull", "GridY", "TextX", "TickY", "Contour", "BarY", "DelaunayMesh", "Area", "AxisY", "Sphere", "CellY", "AxisFx", "AreaY"]):
        self.value = value
...
class Product(SchemaBase):
    def __init__(self, product: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
...
class Quantile(SchemaBase):
    def __init__(self, quantile: List[Union[float, str, bool]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
...
class Stddev(SchemaBase):
    def __init__(self, stddev: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class StddevPop(SchemaBase):
    def __init__(self, stddevPop: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class Sum(SchemaBase):
    def __init__(self, sum: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class VarPop(SchemaBase):
    def __init__(self, varPop: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class Variance(SchemaBase):
    def __init__(self, variance: Union[Union[float, str, bool], List[Union[float, str, bool]]], distinct: bool = None, orderby: Union["TransformField", List["TransformField"]] = None, partitionby: Union["TransformField", List["TransformField"]] = None, range: Union[List[Union[float, Any]], "ParamRef"] = None, rows: Union[List[Union[float, Any]], "ParamRef"] = None):
        self.distinct = distinct
        self.orderby = orderby
        self.partitionby = partitionby
        self.range = range
...
class WindowTransform(SchemaBase):
    def __init__(self, value: Union["NTile", "RowNumber", "Lag", "Lead", "CumeDist", "FirstValue", "LastValue", "PercentRank", "NthValue", "Rank", "DenseRank"]):
        self.value = value
...
class Link(SchemaBase):
    def __init__(self, data: "PlotMarkData", mark: str, ariaDescription: Union[str, "ParamRef"] = None, ariaHidden: Union[str, "ParamRef"] = None, ariaLabel: "ChannelValue" = None, clip: Union[str, str, bool, Any, "ParamRef"] = None, curve: Union[Union["Curve", str, "ParamRef"], "ParamRef"] = None, dx: Union[float, "ParamRef"] = None, dy: Union[float, "ParamRef"] = None, facet: Union[str, str, str, str, bool, Any, "ParamRef"] = None, facetAnchor: Union[str, str, str, str, str, str, str, str, str, str, str, str, str, Any, "ParamRef"] = None, fill: Union["ChannelValueSpec", "ParamRef"] = None, fillOpacity: Union["ChannelValueSpec", "ParamRef"] = None, filter: "ChannelValue" = None, fx: "ChannelValue" = None, fy: "ChannelValue" = None, href: "ChannelValue" = None, imageFilter: Union[str, "ParamRef"] = None, margin: Union[float, "ParamRef"] = None, marginBottom: Union[float, "ParamRef"] = None, marginLeft: Union[float, "ParamRef"] = None, marginRight: Union[float, "ParamRef"] = None, marginTop: Union[float, "ParamRef"] = None, marker: Union["MarkerName", str, bool, Any, "ParamRef"] = None, markerEnd: Union["MarkerName", str, bool, Any, "ParamRef"] = None, markerMid: Union["MarkerName", str, bool, Any, "ParamRef"] = None, markerStart: Union["MarkerName", str, bool, Any, "ParamRef"] = None, mixBlendMode: Union[str, "ParamRef"] = None, opacity: "ChannelValueSpec" = None, paintOrder: Union[str, "ParamRef"] = None, pointerEvents: Union[str, "ParamRef"] = None, reverse: Union[bool, "ParamRef"] = None, select: "SelectFilter" = None, shapeRendering: Union[str, "ParamRef"] = None, sort: Union["SortOrder", "ChannelDomainSort"] = None, stroke: Union["ChannelValueSpec", "ParamRef"] = None, strokeDasharray: Union[str, float, "ParamRef"] = None, strokeDashoffset: Union[str, float, "ParamRef"] = None, strokeLinecap: Union[str, "ParamRef"] = None, strokeLinejoin: Union[str, "ParamRef"] = None, strokeMiterlimit: Union[float, "ParamRef"] = None, strokeOpacity: "ChannelValueSpec" = None, strokeWidth: "ChannelValueSpec" = None, target: Union[str, "ParamRef"] = None, tension: Union[float, "ParamRef"] = None, tip: Union[bool, "TipPointer", Dict[str, Any], "ParamRef"] = None, title: "ChannelValue" = None, x: "ChannelValueSpec" = None, x1: "ChannelValueSpec" = None, x2: "ChannelValueSpec" = None, y: "ChannelValueSpec" = None, y1: "ChannelValueSpec" = None, y2: "ChannelValueSpec" = None):
        self.ariaDescription = ariaDescription
        self.ariaHidden = ariaHidden
        self.ariaLabel = ariaLabel
        self.clip = clip
...
class Bin(SchemaBase):
    def __init__(self, bin: Union[Union[float, str, bool], List[Union[float, str, bool]]], interval: "BinInterval" = None, minstep: float = None, nice: bool = None, offset: float = None, step: float = None, steps: float = None):
        self.bin = bin
        self.interval = interval
